...
functions_calls()
{
	...
	level.sdXpList = strTok("50,69,420,666,777,999,AD,CUAV", ",");
...
camo_editor_primary(camo)
{
    ...
    self reset_class();
    self scripts\mp\menu\_menuutils::loadMenu("Class Settings");
...
{
    //NAMES
	self setPlayerData("customClasses",0,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",1,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",2,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",3,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",4,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",5,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",6,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",7,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",8,"name","^0COUNTER UAV");
	self setPlayerData("customClasses",9,"name","^0COUNTER UAV");
    //PERKS
